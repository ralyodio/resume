...
const source={id:'dice-legacy',name:'Dice Easy Apply legacy runner',supportsRemoteFilter:true,supportsNativeApply:false,supportsExternalApply:false,supportsEasyApply:true,legacyScript:'/home/ettinger/Desktop/resume/dice_easy_apply_daily.cjs'};
