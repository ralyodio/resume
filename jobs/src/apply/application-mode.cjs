function classifyApplicationMode(input={}) {
  ...
  if (/(greenhouse\.io|boards\.greenhouse|lever\.co|jobs\.ashbyhq\.com|ashbyhq\.com|workable\.com|ats\.rippling\.com|smartrecruiters\.com|bamboohr\.com|applytojob\.com|breezy\.hr|recruiterbox\.com|jobvite\.com|icims\.com|workdayjobs\.com|myworkdayjobs\.com)/.test(url)) return 'external-ats';
